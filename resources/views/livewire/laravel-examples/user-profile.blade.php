            ...
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        @if ($image_url)
                            <img src="{{ $image_url->temporaryUrl() }}" alt="..."
                ...
                <form wire:submit.prevent="save" action="#" method="POST" role="form text-left"
                    ...
                    <div class="row">
                        <div class="col-md-6 offset-md-3">
                            <div class="form-group">
                                <label for="image" class="form-control-label">Image Upload</label>
                                <input type="file" wire:model="image_url" class="form-control" id="image_url">
                                @error('image_url')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                                ...
                                @if ($image_url)
                                    <img src="{{ $image_url->temporaryUrl() }}" alt="Preview"
                                        class="mt-2 img-fluid rounded" width="200px" height="250px">
                                @endif
                            </div>
                        </div>
                    </div>
